...
async def test_fundamental_worker_analyze_full_data(
    ...
    mock_fundamental_worker.earnings_fetcher.fetch_calendar = Mock(
...
async def test_fundamental_worker_earnings_flagging_past(
    ...
    mock_fundamental_worker.fundamental_fetcher.fetch_overview = Mock(return_value=mock_fundamental_overview)
    mock_fundamental_worker.earnings_fetcher.fetch_calendar = Mock(return_value=mock_earnings_calendar_past)
...
async def test_fundamental_worker_earnings_flagging_far(
    ...
    mock_fundamental_worker.fundamental_fetcher.fetch_overview = Mock(return_value=mock_fundamental_overview)
    mock_fundamental_worker.earnings_fetcher.fetch_calendar = Mock(return_value=mock_earnings_calendar_far)
...
async def test_fundamental_worker_earnings_flagging_no_events(
    ...
    mock_fundamental_worker.fundamental_fetcher.fetch_overview = Mock(return_value=mock_fundamental_overview)
    mock_fundamental_worker.earnings_fetcher.fetch_calendar = Mock(return_value=mock_earnings_calendar_empty)
